// gcc -I/usr/include/SDL2 -o AnimatedSpriteSheet_test Examples/SDL2/AnimatedSpriteSheet_test.c Core/Graphics/src/sprite.c Core/Graphics/src/tilemap.c Core/Graphics/src/aspect.c Core/Graphics/src/window.c Core/Graphics/src/frame.c -lSDL2 -lSDL2_image -lm && ./AnimatedSpriteSheet_test
