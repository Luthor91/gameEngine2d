// gcc -I/usr/include/SDL2 -o AnimatedSprite_test Examples/SDL2/animated_sprite_test.c Core/Graphics/src/sprite.c Core/Graphics/src/tilemap.c Core/Graphics/src/aspect.c Core/Graphics/src/window.c Core/Graphics/src/frame.c Core/Graphics/src/animated_sprite.c -lSDL2 -lSDL2_image -lm && ./AnimatedSprite_test
