...
int main(int argc, char* argv[]) {
    ...
    Texture* texture_animation = Texture_Init(window->renderer, "Assets/Image/arrows.png");
    ...
    AnimationFrame** animation_frames = Generate_AnimationFramesWithTransform(tilemap_arrows, transforms);
